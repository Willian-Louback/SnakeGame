    ...
    const renderList = () => {
        for(let i = 0; i < 10; i++){
            ...
            if(data.listRanking[i]){
                i === 0 ? spanName.innerHTML = `<i class="bi bi-trophy first"></i> Name: ${data.listRanking[i].userName}`
                    : (i === 1) ? spanName.innerHTML = `<i class="bi bi-trophy second"></i> Name: ${data.listRanking[i].userName}`
                        : (i === 2) ? spanName.innerHTML = `<i class="bi bi-trophy third"></i> Name: ${data.listRanking[i].userName}`
                            : spanName.innerHTML = `Name: ${data.listRanking[i].userName}`;
